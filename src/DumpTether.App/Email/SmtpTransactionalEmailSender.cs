...
internal sealed class SmtpTransactionalEmailSender : IEmailSender
{
    private readonly IOptions<EmailOptions> _emailOptions;

    public SmtpTransactionalEmailSender(IOptions<EmailOptions> emailOptions)
    {
    ...
    public async Task SendAsync(EmailMessage message, CancellationToken cancellationToken)
    {
        ...
        using var mailMessage = new MailMessage
        {
            ...
            Body = string.IsNullOrWhiteSpace(message.HtmlContent) ? message.TextContent : message.HtmlContent,
        ...
        using var client = new SmtpClient(smtp.Host, smtp.Port)
        {
            ...
            Credentials = smtp.UseAuthentication
