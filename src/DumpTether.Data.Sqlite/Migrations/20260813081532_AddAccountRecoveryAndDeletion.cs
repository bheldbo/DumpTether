    ...
    public partial class AddAccountRecoveryAndDeletion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE app_users SET has_password_credential = 0 " +
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reminder_due_at = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    scheduled_for = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    reminder_sent_at = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    reminder_claimed_at = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_account_deletion_requests_state_reminder_due_at_reminder_sent_at",
