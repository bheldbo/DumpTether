...
const translations = {
  en: {
    ...
    oauthLoginHelp: 'Future Google/Microsoft login; backend config will be required before enabling it.',
    offline: 'Offline',
    online: 'Online',
    overview: 'All tasks',
    password: 'Password',
  ...
  da: {
    ...
    notes: 'Noter',
    oauthLogin: 'OAuth-login',
    oauthLoginHelp: 'Fremtidigt Google/Microsoft-login; backend-konfiguration kræves før det slås til.',
    offline: 'Offline',
    online: 'Online',
